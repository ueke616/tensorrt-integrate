...
namespace Yolo{
    ...
    // InferController 就是消费者模型的封装, 避免咱们写大量重复的线程代码
    // 比如说启动线程、停止线程、添加任务到队列、从队列获取任务
    ...
    public:
        ...
        virtual bool preprocess(Job& job, const Mat& image) override{
            ...
            size_t size_matrix     = iLogger::upbound(sizeof(job.additional.d2i), 32);  // d2i 逆变换
